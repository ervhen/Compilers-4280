...
enum tokenID { IDENT_tk, NUM_tk, KW_tk, equal_tk, less_than_tk, great_th_tk, col_tk, plus_tk, minus_tk, mult_tk, div_tk, mod_tk, comma_tk, op_brace_tk, clo_brace_tk, semi_tk, op_brack, close_brak_tk, quot_tk, ERR_tk };

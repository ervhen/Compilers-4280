...
Node *mstat(){
    Node *newnode = new Node;
    newnode->names = "mstat";
    if ( (tk.tokenInstance.compare("scan") == 0) || (tk.tokenInstance.compare("print") == 0) || (tk.tokenInstance.compare("cond") == 0) || (tk.tokenInstance.compare("iter") == 0) || (tk.tokenIdent == IDENT_tk) || (tk.tokenInstance.compare("iter") == 0)){
        newnode->left = stat();
        if (tk.tokenInstance.compare(";") == 0){
            tk = scanner();
            newnode->right = mstat();
